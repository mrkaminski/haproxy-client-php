...
# **createSite**
> \Swagger\Client\Model\Site createSite($body, $transaction_id, $version, $force_reload)
...
$body = new \Swagger\Client\Model\Site(); // \Swagger\Client\Model\Site | 
...
try {
    $result = $apiInstance->createSite($body, $transaction_id, $version, $force_reload);
    print_r($result);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Site**](../Model/Site.md)|  |
...
[**\Swagger\Client\Model\Site**](../Model/Site.md)
...
# **deleteSite**
> deleteSite($name, $transaction_id, $version, $force_reload)
...
$name = "name_example"; // string | Site frontend name
$transaction_id = "transaction_id_example"; // string | ID of the transaction where we want to add the operation. Cannot be used when version is specified.
$version = 56; // int | Version used for checking configuration version. Cannot be used when transaction is specified, transaction has it's own version.
$force_reload = false; // bool | If set, do a force reload, do not wait for the configured reload-delay. Cannot be used when transaction is specified, as changes in transaction are not applied directly to configuration.

try {
    $apiInstance->deleteSite($name, $transaction_id, $version, $force_reload);
} catch (Exception $e) {
...
# **getSite**
> \Swagger\Client\Model\InlineResponse2001 getSite($name, $transaction_id)
...
try {
    $result = $apiInstance->getSite($name, $transaction_id);
    print_r($result);
} catch (Exception $e) {
...
# **getSites**
> \Swagger\Client\Model\InlineResponse200 getSites($transaction_id)
...
try {
    $result = $apiInstance->getSites($transaction_id);
    print_r($result);
} catch (Exception $e) {
...
# **replaceSite**
> \Swagger\Client\Model\Site replaceSite($body, $name, $transaction_id, $version, $force_reload)
...
try {
    $result = $apiInstance->replaceSite($body, $name, $transaction_id, $version, $force_reload);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SitesApi->replaceSite: ', $e->getMessage(), PHP_EOL;
}
?>
```
