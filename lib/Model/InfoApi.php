 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InfoApi implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'info_api';
...
'version' => 'getVersion'    ];
     ...
     * Sets build_date
     *
     * @param \DateTime $build_date HAProxy Dataplane API build date
     *
     * @return $this
     */
     ...
     * Sets version
     *
     * @param string $version HAProxy Dataplane API version string
     *
     * @return $this
     */
