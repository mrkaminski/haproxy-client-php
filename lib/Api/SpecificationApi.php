...
class SpecificationApi
{
    ...
    {
        list($response) = $this->getSpecificationWithHttpInfo();
        return $response;
    }
     ...
     */
    public function getSpecificationWithHttpInfo()
    {
        $returnType = 'object';
        $request = $this->getSpecificationRequest();
     ...
     */
    public function getSpecificationAsync()
    {
        return $this->getSpecificationAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSpecificationAsyncWithHttpInfo()
    {
        $returnType = 'object';
        $request = $this->getSpecificationRequest();
     ...
     */
    protected function getSpecificationRequest()
    {

        $resourcePath = '/specification';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
